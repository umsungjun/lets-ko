      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <a
            ...
            className="flex items-center gap-1.5 px-4 py-2 rounded-xl border border-border bg-white text-muted hover:text-primary hover:border-primary/40 transition-all duration-300 text-sm font-medium cursor-pointer shrink-0"
          >
            {t("moreNews")}
            <svg
              className="w-4 h-4"
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-semibold text-sm text-foreground line-clamp-2 group-hover:text-primary transition-colors duration-300 leading-snug">
                      {article.title}
                    </h3>
                    <div className="flex items-center gap-2 mt-2.5">
                      ...
                      <svg
                        className="w-3.5 h-3.5 text-muted/0 group-hover:text-primary/50 transition-all duration-300 ml-auto shrink-0"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
