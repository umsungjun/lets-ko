        ...
        <div className="flex flex-col md:flex-row items-center md:items-end min-h-130 md:min-h-150">
          ...
          <div className="flex-1 px-6 py-12 md:py-20 text-center md:text-left z-10 order-2 md:order-1 animate-fade-up">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 mb-6">
              ...
              <a
                href="https://www.instagram.com/ko.seokhyeon/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 text-white/80 text-sm font-medium border border-white/15 hover:bg-white/20 hover:text-white transition-all cursor-pointer"
              >
                <svg
                  className="w-4 h-4"
                  fill="currentColor"
